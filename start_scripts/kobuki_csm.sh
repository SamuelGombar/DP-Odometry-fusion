...
/usr/bin/gnome-terminal --tab -- bash -c "ros2 run ros2_laser_scan_matcher laser_scan_matcher --ros-args -p scan_topic:=/scan -p wheel_odom_topic:=/odom -p use_point_to_line_distance:=1; exec bash" &
